...
# ---------------------------------------------------------------------------
# Quick standalone test (does not require hardware — prints simulated events)
# ---------------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    print("DipMonitor self-test: simulating voltage samples through state machine...")

    # Build a dummy meter that returns scripted voltages
    class FakeMeter:
    ...
    # Script: 10 normal, 5 dip, 10 normal, 3 swell, 10 normal
    script = (
        [230.0] * 10
        + [195.0] * 5
        + [230.0] * 15
